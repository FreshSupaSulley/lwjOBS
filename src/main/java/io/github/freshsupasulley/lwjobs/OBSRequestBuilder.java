package io.github.freshsupasulley.lwjobs;

import io.github.freshsupasulley.lwjobs.requests.OBSRequest;
...
public class OBSRequestBuilder<T extends OBSRequest> {
	...
	public void queue()
	{
		controller.sendRequest(new OBSBuiltRequest<>(request, onSuccess, onFailed));
	}
	...
	{
		return controller.sendRequest(new OBSBuiltRequest<>(request, onSuccess, onFailed));
	}
}
